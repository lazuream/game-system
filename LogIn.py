...
"}")
        ...
        self.label_UserState = QtWidgets.QLabel(self.page_Login)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
...
"font: 16pt \"楷体\";")
        ...
        self.lineEdit_L_AccountNumber = QtWidgets.QLineEdit(self.page_Login)
...
"}")
        ...
        self.stackedWidget_LR.addWidget(self.page_Login)
...
"font: 16pt \"楷体\";")
        ...
        self.lineEdit_Manufacturer_Manufacturer_R_AccountNumber = QtWidgets.QLineEdit(self.page_manufacturerRregister)
        self.lineEdit_Manufacturer_Manufacturer_R_AccountNumber.setMinimumSize(QtCore.QSize(0, 35))
        self.lineEdit_Manufacturer_Manufacturer_R_AccountNumber.setText("")
        self.lineEdit_Manufacturer_Manufacturer_R_AccountNumber.setObjectName("lineEdit_Manufacturer_Manufacturer_R_AccountNumber")
        self.verticalLayout_12.addWidget(self.lineEdit_Manufacturer_Manufacturer_R_AccountNumber)
...
"}")
        ...
        self.pushButton_userRegister = QtWidgets.QPushButton(self.frame_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_userRegister.sizePolicy().hasHeightForWidth())
        self.pushButton_userRegister.setSizePolicy(sizePolicy)
        self.pushButton_userRegister.setStyleSheet("QPushButton{\n"
"    border:none;\n"
"}\n"
"QPushButton:pressed{\n"
"    padding-top:2px;\n"
"}")
        self.pushButton_userRegister.setText("")
        self.pushButton_userRegister.setIcon(icon1)
        self.pushButton_userRegister.setObjectName("pushButton_userRegister")
        self.horizontalLayout.addWidget(self.pushButton_userRegister)
        self.pushButton_manufacturerRegister = QtWidgets.QPushButton(self.frame_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_manufacturerRegister.sizePolicy().hasHeightForWidth())
        self.pushButton_manufacturerRegister.setSizePolicy(sizePolicy)
        self.pushButton_manufacturerRegister.setStyleSheet("QPushButton{\n"
"    border:none;\n"
"}\n"
"QPushButton:pressed{\n"
"    padding-top:2px;\n"
"}")
        self.pushButton_manufacturerRegister.setText("")
        self.pushButton_manufacturerRegister.setIcon(icon1)
        self.pushButton_manufacturerRegister.setObjectName("pushButton_manufacturerRegister")
        self.horizontalLayout.addWidget(self.pushButton_manufacturerRegister)
...
"}")
    ...
    def retranslateUi(self, LRMainWindow):
        ...
        self.label_UserState.setText(_translate("LRMainWindow", "登录"))
        ...
        self.lineEdit_Manufacturer_Manufacturer_R_AccountNumber.setPlaceholderText(_translate("LRMainWindow", "账号（长度大于16）："))
